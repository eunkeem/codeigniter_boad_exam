...
<body>
  ...
  <div class="container p-5" id="writeBody" style="display: none; width: 80%; height: 40rem; background-color: white;">
    <div class="row my-3">
      <div class="col-12">
        <label>이름</label>
        <input type="text" class="form-control border border-2" name="name" id="name">
      </div>
    </div>
    ...
    <div class="row my-3">
      <div class="col-12">
        <label>제목</label>
        <input type="text" class="form-control border border-2" name="title" id="title">
      </div>
    </div>
    <!-- contents -->
    <div class="row mt-3">
      <div class="col-12">
        ...
        <textarea class="form-control border border-2" placeholder="Leave a comment here" id="contents" name="contents"
